...
class __TwigTemplate_a0c31a4354cb2c3c5be987e0bca05ab7 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        ";
                ...
                if (twig_get_attribute($this->env, $this->source, $context["item"], "url", [], "any", false, false, true, 15)) {
                    ...
                    echo "</a><i class=\"icon-angle-right\"></i>
        ";
                } else {
                    // line 18
                    echo "          ";
...
";
    ...
    {
        return new Source("", "themes/zuvi/templates/navigation/breadcrumb.html.twig", "C:\\wamp64\\www\\drupal-project\\web\\themes\\zuvi\\templates\\navigation\\breadcrumb.html.twig");
    }
