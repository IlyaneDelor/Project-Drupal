...
class __TwigTemplate_7d6a8211c99094e25bce96368f68fbf3 extends Template
{
    private $source;
    private $macros = [];
  ...
  ";
    ...
    <h2";
            // line 32
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["title_attributes"] ?? null), "addClass", ["comments-title"], "method", false, false, true, 32), 32, $this->source), "html", null, true);
  ...
  ";
      ...
      <h2";
            // line 40
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content_attributes"] ?? null), "addClass", ["add-comment-title"], "method", false, false, true, 40), 40, $this->source), "html", null, true);
            echo "><i class=\"icon-comment-add theme-color\"></i> ";
...
";
    ...
    {
        return new Source("", "themes/zuvi/templates/field/field--comment.html.twig", "C:\\wamp64\\www\\drupal-project\\web\\themes\\zuvi\\templates\\field\\field--comment.html.twig");
    }
